        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0b1e3b]/30 backdrop-blur-sm px-4">
          <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
            <div className="flex items-center justify-between border-b border-[#edf1f5] pb-4">
              <h2 className="text-lg font-semibold text-[#112b52]">Tambah Klien Baru</h2>
            ...
            <form onSubmit={onSubmit} className="mt-5 space-y-4">
              ...
              <p className="text-[10px] text-[#8ca0b9]">
                Catatan: Untuk klien bisa login ke portal, mereka harus mendaftar via halaman utama menggunakan email yang sama dengan email ini.
              </p>
